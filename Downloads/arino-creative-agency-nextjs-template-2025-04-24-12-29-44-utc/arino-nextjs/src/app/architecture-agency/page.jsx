...
export default function ArchitectureAgencyHome() {
  return (
    <>
      <Hero9
        title="Remlyx.com Wheres Vision Meets Structure."
            ...
            <div className="col-lg-7 offset-xl-1">
              <div className="cs-iconbox_4_wrap">
                <IconBoxStyle2
                  ...
                  subTitle="Crafting aesthetic and functional interior spaces that reflect your vision, from conceptualization to meticulous execution and material selection."
                ...
                <IconBoxStyle2
                  ...
                  subTitle="Developing strategic urban plans and master layouts that foster sustainable communities, balancing growth with environmental and social considerations."
                ...
                <IconBoxStyle2
                  ...
                  subTitle="Integrating eco-friendly principles and materials to create environmentally responsible and energy-efficient architectural solutions for a greener future."
                ...
                <IconBoxStyle2
                  title="3D Modeling"
                  subTitle="Providing detailed and realistic 3D modeling and visualization services, bringing architectural concepts to life for presentations and approvals."
      ...
      >
        <div className="container">
          <FunFact
            variant="cs-type2"
            title="Our fun fact"
            subtitle="A glimpse into our journey of creativity and collaboration, marked by successful projects and satisfied clients worldwide."
            data={funfaceData}
          />
        </div>
      </section>
