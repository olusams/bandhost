...
export default function Home() {
  ...
  return (
    <>
    <Head>
      <title>Gaming PCs & Equipment - Playhost</title>
      <meta name="description" content="Experience the ultimate gaming setup at Playhost. High-performance gaming PCs, VR equipment, and premium gaming peripherals available for rent or purchase in Yorkshire." />
