      ...
      <div className="container-custom relative z-10">
        <div className="flex items-center justify-between py-5">
          ...
          <div className="hidden lg:block">
            <Link
              to="/appointment"
              className="btn-primary group relative overflow-hidden shadow-xl hover:shadow-2xl"
            >
              <span className="relative z-10 flex items-center justify-center space-x-3 px-8 py-4">
                <svg className="w-5 h-5 group-hover:rotate-12 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                <span className="btn-text text-base tracking-wide">Book Appointment</span>
              </span>
        ...
        <div className={`lg:hidden transition-all duration-700 overflow-hidden ${
          ...
          <div className="py-6 space-y-2 border-t border-gray-200/50">
            ...
            <div className="pt-6">
              <Link
                to="/appointment"
                className="w-full btn-primary text-center shadow-xl"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                <span className="flex items-center justify-center space-x-3 py-4">
