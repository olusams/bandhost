...
const serviceData = [
  {
    ...
    subtitle:
      'Crafting robust and scalable WordPress solutions tailored to your business needs, from custom themes to plugin development.',
    href: '/service/service-details',
  },
  {
    title: 'UI/UX Design',
    subtitle:
      'Designing intuitive and engaging user experiences that captivate your audience and enhance usability across all digital platforms.',
    href: '/service/service-details',
  },
  {
    title: 'Branding',
    subtitle:
      'Building compelling brand identities that resonate with your target market and tell your unique story, from logo design to complete brand guidelines.',
    href: '/service/service-details',
  },
  {
    title: 'Social Ad Campaign',
    subtitle:
      'Developing and executing targeted social media advertising campaigns that drive engagement, increase reach, and deliver measurable results.',
    href: '/service/service-details',
  },
];
