        ...
        <Div className="row">
          <Div className="col-lg-4">
            <IconBox
              ...
              title='Sketching'
              subtitle='We begin by translating ideas into initial sketches, exploring various concepts and visual directions to lay a strong foundation for the design.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              title='Wireframing'
              subtitle='Next, we create detailed wireframes to map out the user flow and interface structure, focusing on functionality and intuitive navigation.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              title='Prototyping'
              subtitle='Interactive prototypes are then developed to simulate the user experience, allowing for early feedback and refinement before final development.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
        </Div>
