...
export default function Home() {
  ...
  return (
    <>
    <Head>
      <title>Playhost - Premier Gaming Experience in Yorkshire</title>
      <meta name="description" content="Playhost - Your premier destination for gaming in Yorkshire. High-performance gaming PCs, esports tournaments, VR experiences, and gaming community events in the heart of Leeds." />
      <meta name="keywords" content="gaming, Leeds, Yorkshire, esports, gaming cafe, VR gaming, gaming tournaments, gaming community" />
