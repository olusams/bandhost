...
export default function Home() {
  ...
  return (
    <>
    <Head>
      <title>Our Location - Playhost in Yorkshire</title>
      <meta name="description" content="Find Playhost in the heart of Leeds city centre. Conveniently located with easy access by public transport, parking, and close to major attractions in Yorkshire." />
